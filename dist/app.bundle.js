...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"default\", function() { return Navigation; });\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nfunction _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }\n\nfunction _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); return Constructor; }\n\nvar Navigation = /*#__PURE__*/function () {\n  function Navigation() {\n    var _this = this;\n\n    _classCallCheck(this, Navigation);\n\n    var questions = document.querySelectorAll('.js-faq-question'); // Give the first answer a px height as it starts open and transition won't work on non px value\n\n    var answers = document.querySelectorAll('.js-faq-answer');\n    answers[0].style.maxHeight = \"\".concat(answers[0].scrollHeight, \"px\");\n    questions.forEach(function (question) {\n      question.addEventListener('click', function () {\n        _this.hideActiveQuestions();\n\n        var associatedAnswer = question.nextElementSibling;\n        associatedAnswer.classList.add('faqs__answer--active');\n        associatedAnswer.style.maxHeight = \"\".concat(associatedAnswer.scrollHeight, \"px\");\n        associatedAnswer.setAttribute('aria-hidden', 'false');\n      });\n    });\n  }\n\n  _createClass(Navigation, [{\n    key: \"hideActiveQuestions\",\n    value: function hideActiveQuestions() {\n      var answers = document.querySelectorAll('.js-faq-answer');\n      answers.forEach(function (answer) {\n        answer.style.maxHeight = 0;\n        answer.setAttribute('aria-hidden', 'true');\n      });\n    }\n  }]);\n\n  return Navigation;\n}();\n\n\n\n//# sourceURL=webpack:///./src/scripts/modules/faqs.js?");
